    ...
    return (
        <Feature feature={feature} answer={answer}>
            <form onSubmit={submit} className="p-8 grid grid-cols-2 gap-3">
                <div>
                    <InputLabel htmlFor="weight" value="Weight" className="dark:text-white"/>
                    <TextInput id="weight" type="text" name="weight" value={data.weight} 
                ...
                <div>
                    <InputLabel htmlFor="height" value="Height" className="dark:text-white" />
                    <TextInput id="height" type="text" name="height" value={data.height} 
                ...
                <div className="flex items-center justify-end mt-4 col-span-2">
                    <PrimaryButton className="ms-4  dark:bg-white dark:text-black" disabled={processing}>Calculate</PrimaryButton>
                </div>
            </form>
        </Feature>
    )
